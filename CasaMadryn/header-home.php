...
<body style="font-family: 'Old Standard TT', serif;color: #716e6b;">
	<section style="background-image: url('<?php echo site_url(); ?>/wp-content/themes/CasaMadryn/assets/img/banner.png');background-repeat: no-repeat;background-size: cover;background-position: center;position: relative;min-height: 90vh;">
        <div class="bg-op"></div>
		<nav class="navbar navbar-light navbar-expand-md navigation-clean-search py-4" style="background: linear-gradient(to bottom, rgba(87,87,87,1) 0%, rgba(53,53,53,0) 44%, rgba(10,10,10,0) 99%);border-bottom: 1px solid rgb(143,143,143);">
            <div class="container">
                <h4 class="heading">
                ...
                <div class="collapse navbar-collapse d-md-flex justify-content-md-between justify-content-md-center text-center" id="navcol-1">
                    <ul class="nav navbar-nav d-flex d-xl-flex align-items-center align-items-xl-center" style="text-transform: uppercase;">
                        <li class="nav-item" role="presentation"><a class="nav-link" href="<?php echo home_url(''); ?>">Home</a></li>
						<li class="nav-item" role="presentation"><a class="nav-link" href="#casa">Casa Azul</a></li>
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link" href="#galery">Fotos</a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link" href="#detalles">detalles</a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link" href="#contactar">contacto</a></li>
        ...
        <section>
            <div class="container">
                <div class="row" style="padding: 5rem 0;">
                    <div class="col text-center" style="padding: 5rem 0;">
                        <p><span style="color: rgb(255,255,255);font-weight: bold;font-family: Oswald, sans-serif;font-size: 24px;padding-top: 16px;padding-bottom: 16px;">Impresionante ubicación - Gran precio</span></p>
							<h1 class="titulo-grande">Descubre<br>Casa Azul Puerto Madryn</h1>
							<a class="btn btn-warning text-uppercase" style="padding: 15px;font-weight: bold;font-family: Oswald, sans-serif;" href="#contactar">Reservar ahora!</a>
						</div>
                </div>
            </div>
        </section>
