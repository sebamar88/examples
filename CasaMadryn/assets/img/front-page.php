<?php get_header('home'); ?>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">                    
                    <div class="embed-responsive embed-responsive-4by3">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/j_Zy4MxrtMQ" id="iframeVideo"></iframe>
                    </div>
            </div>
  ...
  <div class="row">
    <div class="col-lg-3 col-md-4 col-sm-6" data-toggle="modal" data-target="#modal">
      <a href="#lightbox" data-slide-to="0"><img src="<?php echo site_utl(); ?>/wp-content/themes/CasaMadryn/assets/img/galeria/1.png" class="img-thumbnail my-3 img-fluid"></a>
    </div>
    <div class="col-lg-3 col-md-4 col-sm-6" data-toggle="modal" data-target="#modal">
      <a href="#lightbox" data-slide-to="1"><img src="<?php echo site_utl(); ?>/wp-content/themes/CasaMadryn/assets/img/galeria/2.png" class="img-thumbnail my-3 img-fluid"></a>
    </div>
    <div class="col-lg-3 col-md-4 col-sm-6" data-toggle="modal" data-target="#modal">
      <a href="#lightbox" data-slide-to="2"><img src="<?php echo site_utl(); ?>/wp-content/themes/CasaMadryn/assets/img/galeria/3.png" class="img-thumbnail my-3 img-fluid"></a>
    </div>
    <div class="col-lg-3 col-md-4 col-sm-6" data-toggle="modal" data-target="#modal">
      <a href="#lightbox" data-slide-to="3"><img src="<?php echo site_utl(); ?>/wp-content/themes/CasaMadryn/assets/img/galeria/4.png" class="img-thumbnail my-3 img-fluid"></a>
    </div>
			...
			<div class="modal-body">
				<div id="lightbox" class="carousel slide" data-ride="carousel" data-interval="5000" data-keyboard="true">
					...
					<div class="carousel-inner">
						<div class="carousel-item active"><img src="<?php echo site_utl(); ?>/wp-content/themes/CasaMadryn/assets/img/galeria/1.png" class="w-100"
							 alt=""></div>
						<div class="carousel-item"><img src="<?php echo site_utl(); ?>/wp-content/themes/CasaMadryn/assets/img/galeria/2.png" class="w-100"
							 alt=""></div>
						<div class="carousel-item"><img src="<?php echo site_utl(); ?>/wp-content/themes/CasaMadryn/assets/img/galeria/3.png" class="w-100"
							 alt=""></div>
						<div class="carousel-item"><img src="<?php echo site_utl(); ?>/wp-content/themes/CasaMadryn/assets/img/galeria/4.png" class="w-100"
							 alt=""></div>
