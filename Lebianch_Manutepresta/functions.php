...
function lebianchseo_css() {
		...
		wp_enqueue_style('custom-css', get_theme_file_uri() . '/assets/css/styles.css', array());
		wp_enqueue_style('bootstrapCSS', 'https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css', array());
		wp_enqueue_style('customBootstrapCSS', get_theme_file_uri() . '/assets/bootstrap/css/bootstrap.min.css', array());
		...
		wp_enqueue_script('BootstrapJS', 'https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js', array(),true, true);
		wp_enqueue_script('popperJS', 'https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js', array(),true, true);



		wp_enqueue_script('nouislider', get_template_directory_uri() . '/assets/js/nouislider.js', array('jqueryNew'), true, true);
